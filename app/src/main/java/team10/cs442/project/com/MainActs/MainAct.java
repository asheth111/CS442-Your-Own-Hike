...
import team10.cs442.project.com.Friend_Lib.FriendItemListActivity;
...
public class MainAct extends Activity {
    ...
    public static String user_saved = "null";
    String pass_saved = "";
    String email_saved = "";

    public static boolean share_on = true;
    public static boolean day_night = false;//false is day
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(day_night){ // is true go for night
            View view = this.getWindow().getDecorView();
            view.setBackgroundColor(0x5748442d);
        }
    ...
    public void set_user_info(Bundle extras){
        ...
        Log.v("intent send", extras.getString("username","").toString());
    ...
    public void OpenLogs(View view){
        if(user_saved.equals("null")){
            Toast.makeText(getApplicationContext(), "Plz Log in!", Toast.LENGTH_LONG).show();
        }
        else {
    ...
    public void OpenShare(View view){
        if(user_saved.equals("null")){
            ...
            if(share_on) {
                ...
                Toast.makeText(getApplicationContext(), "Enable Share First!", Toast.LENGTH_LONG).show();
            }
        }
    }
